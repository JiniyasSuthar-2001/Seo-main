  ...
  render() {
    ...
    element.innerHTML = `
      ...
      <div class="sidebar-scroll-area">
        ...
        <!-- WEBSITE CHECK-UP -->
        <div class="nav-section">
          <div class="nav-section-label">WEBSITE CHECK-UP</div>
          <nav class="nav-group">
            ...
            <a href="/pages" data-link class="nav-item">
              ...
              <span>Pages Found on Your Site</span>
            </a>
          </nav>
        </div>
        ...
        <div class="nav-section">
          <div class="nav-section-label">GOOGLE SEARCH POSITION</div>
          <nav class="nav-group">
            ...
            <a href="/rankings" data-link class="nav-item">
              ...
              <span>Google Ranking Positions</span>
            </a>
          </nav>
        </div>
        ...
        <div class="nav-section">
          <div class="nav-section-label">OTHER BUSINESSES & LINKS</div>
          <nav class="nav-group">
            ...
            <a href="/backlinks" data-link class="nav-item">
              ...
              <span>Links From Other Websites</span>
            </a>
        ...
        <!-- CONNECTED ACCOUNTS -->
        <div class="nav-section">
          <div class="nav-section-label">CONNECTED ACCOUNTS</div>
          <nav class="nav-group">
