    ...
    element.innerHTML = `
      ...
      <div style="padding: 24px 20px 16px; display: flex; align-items: center; gap: 12px; border-bottom: 1px solid var(--sidebar-border);">
        ...
        <div>
          ...
          <div style="font-size: 11px; color: var(--sidebar-text); font-weight: 500;">Command Center</div>
        </div>
      </div>
      ...
      <div style="padding: 16px 12px; display: flex; flex-direction: column; gap: 20px; flex: 1; overflow-y: auto;">
        ...
        <div>
          ...
          <nav class="nav-group">
            <a href="/" data-link class="nav-item ${isActive('/')}">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg>
              <span>Dashboard</span>
            </a>
            <a href="/pages" data-link class="nav-item ${isActive('/pages')}">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line></svg>
              <span>Pages</span>
            </a>
            <a href="/keywords" data-link class="nav-item ${isActive('/keywords')}">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
              <span>Keywords</span>
            </a>
            <a href="/rankings" data-link class="nav-item ${isActive('/rankings')}">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg>
              <span>Rankings</span>
            </a>
            <a href="/backlinks" data-link class="nav-item ${isActive('/backlinks')}">
            ...
            <a href="/internal-links" data-link class="nav-item ${isActive('/internal-links')}">
        ...
        <div>
          <div class="nav-section-label">TOOLS & AUDITS</div>
          <nav class="nav-group">
            <a href="/import" data-link class="nav-item ${isActive('/import')}">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="17 8 12 3 7 8"></polyline><line x1="12" y1="3" x2="12" y2="15"></line></svg>
              <span>Data Import</span>
            </a>
            <a href="/reports" data-link class="nav-item ${isActive('/reports')}">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg>
              <span>Reports</span>
            </a>
            <a href="/crawl-history" data-link class="nav-item ${isActive('/crawl-history')}">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>
              <span>Crawl History</span>
            </a>
            <a href="/alerts" data-link class="nav-item ${isActive('/alerts')}">
        ...
        <div>
          ...
          <nav class="nav-group">
            <a href="/settings" data-link class="nav-item ${isActive('/settings')}">
            ...
            <a href="/help" data-link class="nav-item ${isActive('/help')}">
